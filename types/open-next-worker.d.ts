...
// garantía de haber buildeado antes**: el job encadena `lint && typecheck &&
// test:run && build`, así que el typecheck va primero. Sin esta declaración,
// falla en una rama limpia.
//
