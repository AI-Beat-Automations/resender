...
export const en: AppDict = {
  ...
  accessAgency: {
    eyebrow: "access",
    title: "Your agency doesn't have active access",
    body: "Your agency's Resender account isn't active right now, so you can't see your connections or messages. Your data is still saved. Talk to your agency so they can reactivate it.",
  ...
  metaErrors: {
    ...
    agencyPageLimitReached:
      "Couldn't connect: your agency's plan has no free connections. Ask them to free one up.",
  ...
  actions: {
    ...
    accountSlotFullAgency:
      "Your agency's plan has no free connections. Ask them to free one up and run the connection again.",
    invalidSelection:
