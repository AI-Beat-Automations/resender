...
# Tres planes: Pro sube a $29 y vuelve Business a $199
...
Starter no cambia. Pro sube de $25 a $29 con los mismos límites. Business vuelve a $199 con 40
...
- **Lookup key nueva para Business** (`business_40_monthly` o similar) — rechazada. La key
  ...
  Se transfiere al price nuevo de $199 igual que se hace con Pro: el código no necesita
...
- En Stripe, por entorno (test y live): price nuevo de $29 en el producto Pro con transferencia
  de `pro_monthly` y archivar el de $25; price nuevo de $199 en el producto Business con
