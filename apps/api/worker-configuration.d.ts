/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example` (hash: 07d2c6c605d9ebe983dbcfc1b3b0efcc)
// Runtime types generated with workerd@1.20260722.1 2026-07-29 nodejs_compat
interface __BaseEnv_Env {
	WEBHOOK_DELIVERIES: Queue;
	API_RATE_LIMITER: RateLimit;
	ENVIRONMENT: "staging" | "production";
	PUBLIC_BASE_URL: "https://api-staging.resender.dev" | "https://api.resender.dev";
	WEB_APP_ORIGINS: "[\"https://staging.resender.dev\"]" | "[\"https://resender.dev\"]";
	DATABASE_URL: string;
	AUTH_SECRET: string;
...
declare namespace Cloudflare {
	...
	interface StagingEnv {
		...
		WEB_APP_ORIGINS: "[\"https://staging.resender.dev\"]";
		DATABASE_URL: string;
		AUTH_SECRET: string;
		API_KEY_PEPPER: string;
		TOKEN_ENCRYPTION_KEY: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "PUBLIC_BASE_URL" | "WEB_APP_ORIGINS" | "DATABASE_URL" | "AUTH_SECRET" | "API_KEY_PEPPER" | "TOKEN_ENCRYPTION_KEY" | "META_APP_ID" | "META_APP_SECRET" | "META_VERIFY_TOKEN" | "STRIPE_SECRET_KEY" | "STRIPE_WEBHOOK_SECRET">> {}
}
