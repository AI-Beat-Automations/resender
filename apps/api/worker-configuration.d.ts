/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example` (hash: acc04cc091982bbb7effbfa5a712b652)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "PUBLIC_BASE_URL" | "DATABASE_URL" | "AUTH_SECRET" | "API_KEY_PEPPER" | "TOKEN_ENCRYPTION_KEY" | "META_APP_ID" | "META_APP_SECRET" | "META_VERIFY_TOKEN" | "INSTAGRAM_APP_ID" | "INSTAGRAM_APP_SECRET" | "INSTAGRAM_VERIFY_TOKEN" | "STRIPE_SECRET_KEY" | "STRIPE_WEBHOOK_SECRET">> {}
}
