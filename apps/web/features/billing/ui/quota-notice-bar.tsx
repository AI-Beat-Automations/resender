...
function restrictedMessage(notice: QuotaNoticeView): string {
  switch (notice.blockCode) {
    case "page_limit_exceeded":
      return `Tu plan permite ${formatCount(notice.maxAccounts)} cuentas conectadas y tienes ${formatCount(notice.activeAccountCount)}. Desconecta cuentas para volver a enviar.`
    case "quota_exceeded":
