/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=.wrangler-typegen.json --config=../api/wrangler.jsonc --env-file=.dev.vars.example --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: ce24b7fc9136fc2d9eebcf6847c33735)
// Runtime types generated with workerd@1.20260722.1 2026-07-01 nodejs_compat
interface __BaseEnv_CloudflareEnv {
	ASSETS: Fetcher;
	BACKEND: Service<typeof import("../api/src/index").WebAppApi>;
}
